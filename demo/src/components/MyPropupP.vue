<template>
    <div>
        <group title="single column" label-width="5em">
            ...
            <popup-picker :title="title1" :data="list1" v-model="value1_1" @on-show="onShow" @on-hide="onHide" @on-change="onChange"
        ...
        <group>
            <popup-picker :show="showPopupPicker" :show-cell="false" title="TEST" :data="[['1', '2', '3', '4', '5']]" v-model="value5"
                @on-hide="showPopupPicker=false"></popup-picker>
        </group>
        ...
        <group title="显示格式化">
            <popup-picker title="时间" :inline-desc="`当前值[${formatDemoValue}]`" v-model="formatDemoValue" :data="[['01','02','03'],['11','12','13']]"
